...
?>
    ...
    <div class="wide">
        ...
        <h3 style="color: red" class="tagline2">About the food culture in Le cafe'</h3>
        <br>
        <h3 class="paragraph1">Order food & beverages online from restaurants near & around you. <h3 class= "paragraph2">We deliver food from your neighborhood local joints, your favorite cafes, luxurious & elite restaurants in your area,and also from chains like Dominos, KFC, Burger King, Pizza Hut, FreshMenu, Mc Donald's, Subway, Faasos, Cafe Coffee Day, Taco Bell, and more. Exciting bit?</h3><h3 class="paragraph3"> We place no minimum order restrictions! Order in as little (or as much) as you'd like. We'll Smoothly deliever it to you!</h3></h3>
    </div>
